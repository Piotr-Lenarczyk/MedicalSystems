# Generated by Django 3.2.10 on 2022-01-18 17:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('to_discharge', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='states', to='api.discharge')),
            ],
            options={
                'ordering': ['id'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('to_discharge', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='prescriptions', to='api.discharge')),
            ],
            options={
                'ordering': ['id'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('to_discharge', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='illnesses', to='api.discharge')),
            ],
            options={
                'ordering': ['id'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('to_patient_illness', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='illnesses', to='api.patientillnesses')),
            ],
            options={
                'ordering': ['id'],
            },
